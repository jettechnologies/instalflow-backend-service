...
// src/job-workers/onboarding.worker.ts
var onboardingWorker = new Worker(
  ...
  async (job) => {
    ...
    const transaction = await SubscriptionService.validatePaystackTransaction(reference);
    ...
    if (result) {
      emitEvent("company.onboarded" /* COMPANY_ONBOARDED */, {
